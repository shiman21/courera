...
if ( isset($_GET['code']) ) {
    ...
    } else if ( $code[0] < "0" || $code[0] > "9999" || 
    $code[1] < "0" || $code[1] > "9999"||$code[2]< "0" || $code[2] > "9999"||$code[3] < "0" || $code[3] > "9999" ) {
        $error = "Input must be less than 10000";
    } else {
        $md5 = hash('md5', $code);
    }
}
?>
<!DOCTYPE html>
<head><title>Mayank Sharma PIN Code</title></head>
<body>
<h1>MD5 PIN Maker</h1>
<?php
if ( $error !== false ) {
